...
推送之后，重新刷新 github 的远端仓库页面，至此，我们的代码开源工作就结束了。



## 关键代码

本节课的课堂代码仅包含一个 `.gitignore` 文件，用于指定不需要提交到远端仓库的目录和文件。

### .gitignore

Git 忽略配置文件，排除 node_modules、coverage 和 dist 目录。
