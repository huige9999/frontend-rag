...
提供真实服务的类，实现了服务接口中定义的 operation 方法。
...
代理类同样实现服务接口，内部持有真实服务的引用。通过 checkAccess 方法对访问进行过滤控制，只有符合要求的请求才会转发给真实服务。
...
客户端创建真实服务和代理对象，之后所有服务请求都通过代理对象进行交互。
