...
#### UserCollection.ts —— 用户集合类，实现集合接口并创建迭代器
...
#### UserIterator.ts —— 用户迭代器，封装具体的遍历算法
...
#### index.js —— 通过实现 Symbol.iterator 可迭代协议，让普通对象支持 for...of 遍历
