...
以下是一个典型的 package.json 配置文件：

```json
{
    "name": "chapter2",
    "version": "1.0.0",
    "description": "useless, just test, will not publish to npm",
    "main": "index.js",
    "scripts": {
    ...
    "repository": {
        "type": "git",
        "url": "git+https://github.com/DuYi-Edu/DuYi-PackageManager.git"
    },
    "author": "yuanjin",
    "license": "ISC",
    "bugs": {
        "url": "https://github.com/DuYi-Edu/DuYi-PackageManager/issues"
    },
    "homepage": "https://github.com/DuYi-Edu/DuYi-PackageManager#readme",
    "dependencies": {
        "jquery": "^3.4.1",
        "lodash": "^4.17.15"
    },
...
从上面的示例可以看到：
- `dependencies` 记录了生产环境依赖（jquery、lodash）
- `devDependencies` 记录了开发环境依赖（mocha 测试框架）
